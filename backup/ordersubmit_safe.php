 ...
 */
	...
	if (!isset($_POST['GoBack']) and !isset($_POST['Submit'])) {
    ...
    if (strlen(trim($_POST['Submit']))>0) { 
	    ...
	    if ($infoFilled==0) {
			...
			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'GF-20','Gluten Free Vanilla Cake 8 ” pan, 450 gram','" .$_POST['GF-20'] . "')";
