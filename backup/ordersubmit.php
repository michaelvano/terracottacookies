 ...
 */
    ...
    if (strlen(trim($_POST['Submit']))>0) { 
	    ...
	    if ($infoFilled==0) {
			...
			$myBody="Please note: Terra Cotta Cookies will email to confirm your order and amount due." . chr(13) . chr(10) . "If you do not hear from us within 24 hours," . chr(13) . chr(10) . "please call 905-877-4216 immediately. Thank you."  . chr(13) . chr(10) . "" . chr(13) . chr(10) . "The following order was submitted:" . chr(13) . chr(10);
			...
			$myBody=$myBody . "3002-D Oatmeal Raisin DeLite 30g, Bulk(96/case) = " . $_POST['3002-D'] . " case(s)" . chr(13) . chr(10);
			...
			$myBody=$myBody . "1103-D Casey's Caramel Choc DeLite Large, Wrapped(48/case) = " . $_POST['1103'] . " case(s)" . chr(13) . chr(10);
			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'1103-D','Casey`s-Caramel . Choc Large, Wrapped(48/case)','" .$_POST['1103'] . "')";
			mysql_query($myQuery);
			}
			...
			$myBody=$myBody . "3003-D Oatmeal Raisin DeLite Large, Wrapped(48/case) = " . $_POST['3003-D'] . " case(s)" . chr(13) . chr(10);
			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'3003-D','Oatmeal Raisin DeLite Large, Wrapped(48/case)','" .$_POST['3003-D'] . "')";
			mysql_query($myQuery);
			}
			...
			$myBody=$myBody . "4103-D White Chunk Fudge DeLite Large, Wrapped(48/case) = " . $_POST['4103'] . " case(s)" . chr(13) . chr(10);
			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'4103-D','White Chunk Fudge Large, Wrapped(48/case)','" .$_POST['4103'] . "')";
			mysql_query($myQuery);
			}
			...
			if (strlen(trim($_POST['1104-D']))>0) {
			$myBody=$myBody .  "1104-D Casey's Caramel & Choc DeLite Large, Bulk(48/case) = " . $_POST['1104-D'] . " case(s)" . chr(13) . chr(10);
			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'1104-D','Casey`s- Caramel & Choc Large, Bulk(48/case)','" .$_POST['1104-D'] . "')";
			mysql_query($myQuery);
			}
			...
			$myBody=$myBody  . "4104-D White Chunk Fudge Large, Bulk(48/case) = " . $_POST['4104'] . " case(s)" . chr(13) . chr(10);
			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'4104-D','White Chunk Fudge Large, Bulk(48/case','" .$_POST['4104'] . "')";
			mysql_query($myQuery);			
			}
...
//
			...
			$myBody=$myBody  . "Ice Dawg I Chocolate Chip (Apr,May&June) Large, Wrapped(48/case) = " . $_POST['IceDawgI'] . " case(s)" . chr(13)  . chr(10);		
			...
			$myBody=$myBody  . "Ice Dawg IV Fudge Chip (Apr,May&June) Large, Wrapped(48/case) = " . $_POST['IceDawgIV'] . " case(s)" . chr(13)  . chr(10);		
			...
			$myBody=$myBody  . "GF-26,27,28 Unbaked Apple, Blueberry, Cherry Pies  8 ” pan, 700 gram = " . $_POST['GF-26'] . " pan(s)" . chr(13) . chr(10);

			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'GF-26,27,28','Unbaked Apple, Blueberry, Cherry Pies  8 ” pan, 700 gram','" .$_POST['GF-26'] . "')";

			mysql_query($myQuery);

			}

			if (strlen(trim($_POST['GF-29']))>0) {

			$myBody=$myBody  . "GF-29 Baked Pumpkin Pie  8 ” pan, 700 gram = " . $_POST['GF-29'] . " pan(s)" . chr(13) . chr(10);

			$myQuery="insert into orders_items (OrderID,Product,ProductName,Qty) values (" . $ID . ",'GF-29','Baked Pumpkin Pie  8 ” pan, 700 gram','" .$_POST['GF-29'] . "')";
