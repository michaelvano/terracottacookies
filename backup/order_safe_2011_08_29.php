...
if($_SESSION['NoError']!=1) {?>
 ...
 <tr class="text">
  ...
  <tr>
   ...
   <td>700 gram</td>
   <td><div align="center">
     <input name="GF-29" id="GF-29" size ="4" /><?php if (isset($_SESSION['GF-29'])) {  echo $_SESSION['GF-29'] ;} ?>"/>
   </div></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colspan="2" align="middle" bgcolor="#ffffff"><div align="left">
     <input name="deliverydate" id="deliverydate" readonly="true" value="<?php if (isset($_SESSION['deliverydate'])) {  echo $_SESSION['deliverydate'];} ?>" />
...
<td id="sidebar">
 ...
 <p>
    <A onFocus="this.blur()" onClick="NewWindow(this.href,'Popup','750','550','yes','center'); return false" href="PDF/Sept2010/T.C.'sMenuSept2010 1.doc">Print T.C.'s Menu</A> (PDF) </p>
