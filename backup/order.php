...
<td id="sidebar">
 ...
 <p>
    <A href="http://www.terracottacookies.com/Jan2012/2012 January-June menu pdf.pdf" target="_new" onFocus="this.blur()" onClick="NewWindow(this.href,'Popup','750','550','yes','center'); return false">Print T.C.'s Menu</A> (PDF) </p>
 ...
 <p align="center"><span class="green">Products are available at our Factory Outlet,<span class="text"> <br>20 Armstrong Ave., Unit 1,
  Georgetown, ON</span> <br>Monday to Friday, 9:00am to 5:00 pm from September to June.</span></p>
...
if($_SESSION['NoError']!=1) {?>
 ...
 <tr>
   ...
   <td width="10%" bgcolor="#CCFFFF"><strong>&nbsp;Order</strong></td>
     ...
     <tr>
   <td ></td>
   <td colspan="2" ><font color="#003399"><strong><span class="textlarge">T.C.'s Original Recipes</span></strong></font></td>
   <td >&nbsp;</td>
   <td >&nbsp;</td>
   <td >&nbsp;</td>
  </tr>
  <tr>
   ...
   <td>288/case</td>
   <td><div align="center">
     <input name="T-1001" id="T-1001" size ="4" value="<?php if (isset($_SESSION['T-1001'])) {  echo $_SESSION['T-1001'] ;} ?>" />
   </div></td>
  </tr>
  <tr>
   <td>T-4101</td>
   ...
   <td>288/case</td>
   <td><div align="center">
     <input name="T-4101" id="T-4101" size ="4" value="<?php if (isset($_SESSION['T-4101'])) {  echo $_SESSION['T-4101'] ;} ?>"/>
   </div></td>
  </tr>
  <tr>
   <td>T-10001 </td>
   ...
   <td>288/case</td>
   <td><div align="center">
     <input name="T-10001" id="T-10001 " size ="4" value="<?php if (isset($_SESSION['T-10001'])) {  echo $_SESSION['T-10001'] ;} ?>"/>
   </div></td>
  </tr><tr class="text">
   <td>&nbsp;</td>
   <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>48/case</td>
   <td><div align="center">
     <input name="1004" id="1004" size="4" value="<?php if (isset($_SESSION['V1004'])) {  echo $_SESSION['V1004'] ;} ?>"/>
   </div></td>
  </tr>
  </tr>
    <tr class="text">
  ...
  <tr>
   ...
   <td>96/case</td>
   <td><div align="center">
     <INPUT name= "1002-D" id="1002-D" size="4" value="<?php if (isset($_SESSION['1002-D'])) {  echo $_SESSION['1002-D'] ;} ?>" />
   </div></td>
  </tr>
  <tr>
   <td>3002-D</td>
   ...
   <td>96/case</td>
   <td><div align="center">
     <input name="3002-D" id="3002-D" size ="4" value="<?php if (isset($_SESSION['3002-D'])) {  echo $_SESSION['3002-D'] ;} ?>" />
   </div></td>
  </tr>
  <tr>
   <td>4002-D </td>
   ...
   <td>96/case</td>
   <td><div align="center">
     <input name="4002-D" id="4002-D" size="4" value="<?php if (isset($_SESSION['4002-D'])) {  echo $_SESSION['4002-D'] ;} ?>" />
   </div></td>
  </tr>
  <tr>
   <td>5002-D </td>
  ...
  <tr>
   <td>1103-D </td>
   <td>Casey&#8217;s<span class="textsmall"> Caramel &amp; Choc DeLite</span> </td>
   <td>Lg, Wrapped </td>
   <td>48/case</td>
   <td><div align="center">
  ...
  <tr>
    ...
    <td>48/case</td>
   <td><div align="center">
     <input name="3003-D" id="3003-D " size ="4" value="<?php if (isset($_SESSION['3003-D'])) {  echo $_SESSION['3003-D'] ;} ?>"/>
   </div></td>
  </tr>
  <tr>
    <td>4003-D</td>
  ...
  <tr>
   <td>4103-D </td>
   <td>White Chunk Fudge DeLite</td>
   <td>Lg, Wrapped </td>
   <td>48/case</td>
   <td><div align="center">
  ...
  <tr>
   <td>5003-D</td>
    ...
    <td>48/case</td>
   <td><div align="center">
     <input name="5003-D" id="5003-D" size="4" value="<?php if (isset($_SESSION['5003-D'])) {  echo $_SESSION['5003-D'] ;} ?>"/>
   </div></td>
  </tr>
  <tr>
    <td>6003-D </td>
  ...
  <td>1104-D </td>
    ...
    <td>48/case </td>
   <td><div align="center">
   <input name="1104-D" id="1104-D" size ="4" value="<?php if (isset($_SESSION['V1104'])) {  echo $_SESSION['V1104'] ;} ?>"/></div>
   </td>
  </tr>
  <tr>
   <td>3004-D </td>
   ...
   <td>48/case</td>
   <td><div align="center">
     <input name="3004-D" id="3004-D" size="4" value="<?php if (isset($_SESSION['3004-D'])) {  echo $_SESSION['3004-D'] ;} ?>"/>
   </div></td>
  </tr>
  <tr>
   <td>4004-D</td>
  ...
  <tr>
   <td>4104-D </td>
    ...
    <td>48/case </td>
   <td><div align="center">
   <input name="4104" id="4104" size ="4" value="<?php if (isset($_SESSION['V4104'])) {  echo $_SESSION['V4104'] ;} ?>"/></div>
   </td>
  </tr>  
  <tr>
    <td>5004-D </td>
   ...
   <td>48/case</td>
   <td><div align="center">
     <input name="5004-D" id="5004-D" size ="4" value="<?php if (isset($_SESSION['5004-D'])) {  echo $_SESSION['5004-D'] ;} ?>"/>
   </div></td><tr>
    <td>6004-D </td>
   <td>Oatmeal DeLite</td>
   <td>Lg, Bulk</td>
  ...
  <tr>
   ...
   <td>Dawg-D </td>
    <td>DuneDawg DeLite</td>
    <td>Wrapped</td>
    <td>48/case </td>
   <td><div align="center">
   <input name="Dawg-D" id="Dawg-D" size ="4" value="<?php if (isset($_SESSION['DAWG-D'])) {  echo $_SESSION['DAWG-D'] ;} ?>"/></div>
   </td>
  </tr>
  <tr>
   <td>Dawg-M </td>
    <td>MudDawg DeLite<span class="textsmall"> (w/chocolate)</span> </td>
    <td>Wrapped</td>
    <td>48/case </td>
   <td><div align="center">
   <input name="Dawg-M" id="Dawg-M" size ="4" value="<?php if (isset($_SESSION['DAWG-M'])) {  echo $_SESSION['DAWG-M'] ;} ?>"/></div>
   </td>
  </tr> 
   <tr class="text">
   <td colspan="5" class="tinygrey"><div align="center">----------------------------------------------------------------------------------------------------------------------</div></td>
  ...
  <tr>
   <td colspan="5"><div align="center"><span class="bluemed">SPECIALTY COOKIES</span><span class="tinyblack"> - (see available months in brackets)</span></div></td>
   </tr>
  <tr>
    <td>8003-P</td>
  ...
  <td>8003-B</td>
   ...
   <td>48/case</td>
   <td><div align="center">
     <input name="8003-B" id="8003-B" size ="4" value="<?php if (isset($_SESSION['8003-B'])) {  echo $_SESSION['8003-B'] ;} ?>"/>
   </div></td>
  </tr>
   <tr class="text">
   <td colspan="5" class="tinygrey"><div align="center">----------------------------------------------------------------------------------------------------------------------</div></td>
  ...
  <tr>
   ...
   <td>48/case</td>
   <td><div align="center">
     <input name="IceDawgI" id="IceDawgI" size ="4" value="<?php if (isset($_SESSION['IceDawgI'])) {  echo $_SESSION['IceDawgI'] ;} ?>"/>
   </div></td>
  </tr>
  ...
  <tr>
   ...
   <td>48/case</td>
   <td><div align="center">
     <input name="IceDawgIV" type="text" id="IceDawgIV" size="4" value="<?php if (isset($_SESSION['IceDawgIV'])) {  echo $_SESSION['IceDawgIV'] ;} ?>"/>
   </div></td>
  </tr>
  ...
  <tr>
   <td colspan="5" ><div align="center"><span class="textlarge"><font color="#003399"><strong>100% 
    PURE UNSWEETENED JUICES </strong></font></span></div></td> <tr>
  <td>OASIS </td>
    <td>Apple Juice </td>
    <td>200 ml tetra </td>
    <td>30/case </td>
  ...
  <td>MILK </td>
    <td>Neilson 1% Chocolate Milk</td>
    <td>250 ml </td>
    <td>48/case </td>
   <td><div align="center">
     <input name="Chocolate1%" id="Chocolate1%" size ="4" value="<?php if (isset($_SESSION['Chocolate1%'])) {  echo $_SESSION['Chocolate1%'] ;} ?>"/>
   </div></td>
  </tr>
  <tr>
  <td>MILK </td>
    <td>Neilson 2% White Milk</td>
    <td>250 ml </td>
    <td>48/case </td>
   <td><div align="center">
     <input name="White2%" id="White2%" size ="4" value="<?php if (isset($_SESSION['White2%'])) {  echo $_SESSION['White2%'] ;} ?>"/>
   </div></td>
  </tr></td>
  </tr><tr>
  ...
  <tr>
   <td>GF-10</td>
    ...
    <td>225 gram</td>
   <td><div align="center">
     <input name="GF-10" type="text" id="GF-10" size="4" value="<?php if (isset($_SESSION['GF-10'])) {  echo $_SESSION['GF-10'] ;} ?>"/>
   </div></td>
  </tr>
  <tr>
   <td>GF-15</td>
   ...
   <td>250 gram</td>
   <td><div align="center">
     <input name="GF-24" id="GF-24" size ="4"  value="<?php if (isset($_SESSION['GF-24'])) {  echo $_SESSION['GF-24'] ;} ?>"/>
   </div></td>
  </tr> <tr>
   ...
   <td>700 gram</td>
   <td><div align="center">
     <input name="GF-26" id="GF-26" size ="4" value="<?php if (isset($_SESSION['GF-26'])) {  echo $_SESSION['GF-26'] ;} ?>"/>
   </div></td>
  </tr><tr>
    <td>GF 29</td>
   <td>Baked Pumpkin Pie</td>
   <td>8&rdquo;  pan</td>
   <td>700 gram</td>
   <td><div align="center">
     <input name="GF-29" id="GF-29" size ="4" value="<?php if (isset($_SESSION['GF-29'])) {  echo $_SESSION['GF-29'] ;} ?>"/>
   </div></td>
  </tr>
  ...
  <tr>
   ...
   <td bgcolor="#ffffff"><input name="datetoday" id="datetoday" value="<?php print date('M d Y H:i', strtotime('+1 hour'));?>" /></td>
   <td bgcolor="#ffffff">
   <?php if (strlen( trim($_SESSION['phone2']) . trim($_SESSION['phone1']) )>0) { ?>
  ...
  <tr>
   ...
   <td colspan="2" align="middle" bgcolor="#ffffff"><div align="left">
     <input name="deliverydate" id="deliverydate" readonly value="<?php if (isset($_SESSION['deliverydate'])) {  echo $_SESSION['deliverydate'];} ?>" />
<a href="javascript:NewCal('deliverydate','mmmddyyyy',false,24)"><img 
                src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
   </div></td>
  </tr>
  <tr>
   <td height="18" colspan="5" bgcolor="#ffffff"><div align="center" class="green"><strong>You should receive a confirmation email, once you press SUBMIT.  We will also email you to confirm your order and amount due. If you do not receive a confirmation email, or we have not confirmed your order within 24 hours, please call us immediately at 905-877-4216.</strong></div></td>
  </tr>
 </table> 
 <p>&nbsp;</p>
<p align="center"> 
