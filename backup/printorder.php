...
<?php if (isset($_SESSION['V4103'])) {  echo $_SESSION['V4103'] ;} ?>
  ...
  <?php } ?>	 
	<?php if (strlen(trim($_SESSION['5003-D']))>0){ ?>
...
<?php if (isset($_SESSION['V1104'])) {  echo $_SESSION['V1104'] ;} ?></div>
	 ...
	 <?php if (strlen(trim($_SESSION['3004-D']))>0){ ?>
...
<?php if (isset($_SESSION['V4104'])) {  echo $_SESSION['V4104'] ;} ?></div>
  ...
  <?php } ?>	 
	<?php if (strlen(trim($_SESSION['5004-D']))>0){ ?>
...
<?php if (isset($_SESSION['GF-26'])) {  echo $_SESSION['GF-26'] ;} ?>
  ...
  <tr>
    <td><span class="tinyblack">GF-298</span></td>
   <td class="tinyblack">Baked Pumpkin Pie </td>
   <td>8&rdquo;  pan</td>
   <td>700 gram</td>
   <td><div align="center">
<?php if (isset($_SESSION['GF-29'])) {  echo $_SESSION['GF-29'] ;} ?>
   </div></td>
  </tr>
  <?php } ?>
  <tr>
