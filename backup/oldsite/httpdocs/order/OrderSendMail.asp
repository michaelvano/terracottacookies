<%
    ...
    if infoFilled=0 then 
   		Session("ErrorMsg")=""
		myBody="Due to the inconsistent nature of email, Terra Cotta Cookies will call to confirm your order and amount due. If you do not hear from us within 24 hours, please call 905-877-4216 immediately. Thank you. The following order was submitted:"
  & chr(13) & chr(10)
...
'		MyCDONTSMail.bcc= "office@terracottacookies.com"
