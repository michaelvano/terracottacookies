<HTML>
    ...
    <TD width="114" ROWSPAN="3"> <IMG SRC="images/pizza.gif" ALT="" WIDTH="114" HEIGHT="237" border="0"></TD>
			...
			<TR>
				...
				<TD COLSPAN="2" ROWSPAN="14" valign="top" background="images/textarea1.gif">
				<form method="post" name="Products" action="ProductSave.asp" id="Products">
				<form method="post" name="Ingredients" action="IngredientsSave.asp" ID="Ingredients">
			    <form method="post" name="About" action="AboutSave.asp" ID="About">
			    <form method="post" name="Order" action="OrderSave.asp" ID="Order">
			    <form method="post" name="Delivery" action="DeliverySave.asp" ID="Delivery">
			    <form method="post" name="Fun" action="FunSave.asp" ID="Fun">
				<form name="form1" method="post" action="OrderSendMail.asp">
        ...
        <table width="98%" border="0" class="text">
          ...
          <tr bgcolor="#FFFFFF"> 
            <td><p>1002-D </p></td>
            <td><p> Chocolate Chip DeLite </p></td>
            <td><p>30g, Bulk </p></td>
            <td><p align="center">96/case </p></td>
            <td height="18" align="center" valign="middle"><div align="center"> 
          ...
          <tr bgcolor="#FFFFFF"> 
            ...
            <td>30g, Bulk </td>
            <td><div align="center">96/case </div></td>
            <td height="18" align="center" valign="middle"><div align="center"> 
          ...
          <tr bgcolor="#FFFFFF"> 
            ...
            <td><div align="center">48/case</div></td>
            <td align="center" valign="middle"><div align="center"> 
                <input name="1004-D" type="text" id="1004-D2" size="4" value="<%if len(Trim(Session("1004-D")))>0 then  Response.Write Session("1004-D") end if %>">
              </div></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td>4004-D </td>
          ...
          <tr bgcolor="#FFFFFF"> 
            ...
            <td align="center"> <%if len(Trim(Session("DeliveryDate")))>0 then %> <div align="left">Delivery Date</div>
              <%else%> <div align="left"><font color="#FF0000"><strong>Delivery 
    ...
    <TD width="86" ROWSPAN="2"> <a href="../newsletter/newsletter.html"><img src="images/eggs_right.gif" alt="" width="86" height="175" border="0"></a></TD>
			...
			<TR>
				<TD ROWSPAN="2">
					<IMG SRC="images/left2.gif" WIDTH="71" HEIGHT="172" ALT=""></TD>
				<TD>
			...
			<TR>
				<TD COLSPAN="3" background="images/box2.gif">&nbsp;&nbsp;&nbsp;<span class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../fundraising/fundraising.html" target="_blank">Click 
							here</a> for our &quot;fun&quot;raising<br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;information</span></TD>
				<TD>
		...
		<map name="Map2">
			<area shape="rect" coords="31,316,200,332" href="../delivery/delivery.html" target="_blank" alt="Delivery Information">
		</map>
<map name="Map3"><area shape="rect" coords="6,44,82,67" href="javascript:document.About.submit()" alt="About Us">
  <area shape="rect" coords="91,44,167,66" href="javascript:document.Products.submit()" alt="Products">
  <area shape="rect" coords="174,42,255,66" href="javascript:document.Ingredients.submit()" alt="Ingredients">
  <area shape="rect" coords="261,42,333,66" href="javascript:document.Order.submit()" alt="Order">
  <area shape="rect" coords="353,43,425,67" href="javascript:document.Delivery.submit()" alt="Delivery">
  <area shape="rect" coords="450,42,529,64" href="javascript:document.Fun.submit()" alt="Fundraising">
</map>
</BODY>
</HTML>
