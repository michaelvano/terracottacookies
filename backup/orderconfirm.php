...
<tr class="text">
 ...
 <tr class="text">
  ...
  <td>1104-D </td>
    ...
    <td>48/case </td>
   <td><div align="center">
   <input name="1104-D" id="1104-D" size ="4" value="<?php if (isset($_SESSION['V1104'])) {  echo $_SESSION['V1104'] ;} ?>" readonly /></div>
   </td>
  </tr>
       <?php }?>
  ...
  <tr>
   ...
   <td><div align="center">
     <input name="GF-26" id="GF-26" size ="4" value="<?php if (isset($_SESSION['GF-26'])) {  echo $_SESSION['GF-26'] ;} ?>" readonly />
       ...
       <?php }
	if (strlen(trim($_SESSION['GF-29']))>0){ ?>

  <tr>
   <td>GF-29</td>
   <td>

Baked Pumpkin Pie </td>
   <td>8&rdquo;  pan</td>
   <td>700 gram</td>
   <td><div align="center">
     <input name="GF-29" id="GF-29" size ="4"  value="<?php if (isset($_SESSION['GF-29'])) {  echo $_SESSION['GF-29'] ;} ?>" readonly />
   </div></td>
  </tr> 
     <?php } ?>
  <tr>
