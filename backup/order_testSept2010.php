...
<tr>
 <td colspan="2" id="menubar"><div id="p7PMM_1" class="p7PMMh10">
  <ul class="p7PMM">
  <li><a href="index.html" class="p7PMM_img"><img src="images/menu_tccookies.jpg" width="78" height="104" alt="T.C.'s Cookies"></a></li>
   <li><a href="index.html" class="p7PMM_img"><img src="images/menu_home.jpg" width="82" height="104" alt="Home"></a></li>
   <li><a href="about.html" class="p7PMM_img"><img src="images/menu_about.jpg" width="78" height="104" alt="About TCs"></a></li>
   <li><a href="products.html" class="p7PMM_img"><img src="images/menu_products.jpg" width="78" height="104" alt="TCs Products"></a></li>
   <li><a href="fun-raising.html" class="p7PMM_img"><img src="images/menu_funraising.jpg" width="78" height="104" alt="Fun-Raising"></a></li>
   <li><a href="ingredients.html" class="p7PMM_img"><img src="images/menu_ingredients.jpg" width="78" height="104" alt="All-natural Ingredients"></a></li>
   <li><a href="order.html" class="p7PMM_img"><img src="images/menu_order.jpg" width="78" height="104" alt="Order Now"></a></li>
   <li><a href="delivery.html" class="p7PMM_img"><img src="images/menu_delivery.jpg" width="80" height="104" alt="Delivery Schedule"></a></li>
   <li><a href="newsletter.html" class="p7PMM_img"><img src="images/menu_newsletter.jpg" width="77" height="104" alt="TC Cookies Newsletter"></a></li>
   <li><a href="contact.html" class="p7PMM_img"><img src="images/menu_contact.jpg" width="78" height="104" alt="Contact Us"></a></li>
  </ul>
...
<td id="maincontent">
 <h1>order</h1>
<form name="form1" method="post" action="order_test2010confirm.php" id="form1">
...
if($_SESSION['NoError']!=1) {?>
 ...
 <tr class="text">
  ...
  <td>1104 </td>
    ...
    <td>48/case </td>
   <td><div align="center">
   <input name="1104" id="1104" size ="4" value="<?php if (isset($_SESSION['V1104'])) {  echo $_SESSION['V1104'] ;} ?>"/></div>
   </td>
  </tr>
  <tr>
   <td>4104 </td>
  ...
  <tr>
   ...
   <td colspan="2" align="middle" bgcolor="#ffffff"><div align="left">
     <input name="deliverydate" id="deliverydate" value="<?php if (isset($_SESSION['deliverydate'])) {  echo $_SESSION['deliverydate'];} ?>" />
   </div></td>y
  </tr>
  <tr>
